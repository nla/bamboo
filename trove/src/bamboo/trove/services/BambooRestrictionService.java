...
public static void main(String[] args){
	...
	Date now = new Date();
	service.currentRules.add(new Rule(1, DocumentStatus.NOT_APPLICABLE, now, 0, null, null, null, null, "(", false));
	service.currentRules.add(new Rule(2, DocumentStatus.ACCEPTED, now, 0, null, null, null, null, "(au,gov,", false));
	service.currentRules.add(new Rule(3, DocumentStatus.NOT_APPLICABLE, now, 0, null, null, null, null, "(au,gov,nla,", false));
	service.currentRules.add(new Rule(4, DocumentStatus.NOT_APPLICABLE, now, 0, null, null, null, null, "(au,gov,nla,trove,", false));
	service.currentRules.add(new Rule(5, DocumentStatus.NOT_APPLICABLE, now, 0, null, null, null, null, "(au,gov,nla,trove,)/home.html", false));
